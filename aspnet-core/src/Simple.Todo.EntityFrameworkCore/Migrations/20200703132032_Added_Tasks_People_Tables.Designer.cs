...
namespace Simple.Todo.Migrations
{
    ...
    [Migration("20200703132032_Added_Tasks_People_Tables")]
    partial class Added_Tasks_People_Tables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Simple.Todo.People.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Simple.Todo.Tasks.Task", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Simple.Todo.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Simple.Todo.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Simple.Todo.Tasks.Task", b =>
                {
                    b.HasOne("Simple.Todo.People.Person", "AssignedPerson")
                        .WithMany()
